class half_div_test extends base_test;
  `uvm_component_utils(half_div_test)

  
  reg_block   m_ral_model; //register model
  half_div_sequence op_seq;// Declare sequence handle
   

  // Constructor declaration
  extern function new(string name="half_div_test", uvm_component parent=null);

  // run_phase declaration
  extern virtual task run_phase(uvm_phase phase);

endclass : half_div_test


// ===================== Implementation =====================

function half_div_test::new(string name, uvm_component parent);
...
task half_div_test::run_phase(uvm_phase phase);
  ...
  phase.raise_objection(this);
    ...
    begin
      ...
      op_seq = half_div_sequence::type_id::create("op_seq");
      if (op_seq == null)
