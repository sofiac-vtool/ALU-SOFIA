class edge_case_test extends base_test;
  `uvm_component_utils(edge_case_test)

  
  reg_block   m_ral_model; //register model
  edge_case_sequence op_seq;// Declare sequence handle
   

  // Constructor declaration
  extern function new(string name="edge_case_test", uvm_component parent=null);

  // run_phase declaration
  extern virtual task run_phase(uvm_phase phase);

endclass : edge_case_test


// ===================== Implementation =====================

function edge_case_test::new(string name, uvm_component parent);
...
task edge_case_test::run_phase(uvm_phase phase);
  ...
  phase.raise_objection(this);
    ...
    begin
      ...
      op_seq = edge_case_sequence::type_id::create("op_seq");
      if (op_seq == null)
