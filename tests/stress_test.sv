class stress_test extends base_test;
  ...
  extern function new(string name="stress_test", uvm_component parent=null);
  //BUILD PHASE
...
function stress_test::new(string name, uvm_component parent);
  super.new(name, parent);
  reps = 50;
endfunction : new
//------------------------------------------------------------------------------------------------------------
function void stress_test::build_phase(uvm_phase phase);
...
task stress_test::run_phase(uvm_phase phase);
