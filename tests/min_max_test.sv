class min_max_test extends base_test;
  ...
  min_max_sequence op_seq;// Declare sequence handle
   

  // Constructor declaration
  extern function new(string name="min_max_test", uvm_component parent=null);
...
function min_max_test::new(string name, uvm_component parent);
...
task min_max_test::run_phase(uvm_phase phase);
  ...
  phase.raise_objection(this);
    ...
    begin
      ...
      op_seq = min_max_sequence::type_id::create("op_seq");
      if (op_seq == null)
