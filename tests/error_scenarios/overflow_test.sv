class error_overflow_test extends base_test;
  `uvm_component_utils(error_overflow_test)

  
  reg_block   m_ral_model; //register model
  error_overflow_sequence op_seq;// Declare sequence handle
   

  // Constructor declaration
  extern function new(string name="error_overflow_test", uvm_component parent=null);

  // run_phase declaration
  extern virtual task run_phase(uvm_phase phase);

endclass : error_overflow_test


// ===================== Implementation =====================

function error_overflow_test::new(string name, uvm_component parent);
...
task error_overflow_test::run_phase(uvm_phase phase);
